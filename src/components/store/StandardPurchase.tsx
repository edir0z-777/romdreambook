...
const bundles = [
  {
    ...
    price: 69,
    description: 'ספר אחד',
    paymentLink: 'https://pay.grow.link/60567760653c25001044711e6bcd57fe-MTYyMDU2NA?success_url=' + encodeURIComponent(window.location.origin + '/thank-you')
  },
  {
    id: 'double',
    quantity: 2,
    ...
    paymentLink: 'https://pay.grow.link/4b9c04456a9a7b7e2a7bd474fbdaf3f3-MTYyMDc1OQ?success_url=' + encodeURIComponent(window.location.origin + '/thank-you')
  },
  {
    id: 'triple',
    quantity: 3,
    ...
    paymentLink: 'https://pay.grow.link/d82445cd2b91b15349d1a18e060ac8af-MTYyMDc4MA?success_url=' + encodeURIComponent(window.location.origin + '/thank-you')
  }
];
